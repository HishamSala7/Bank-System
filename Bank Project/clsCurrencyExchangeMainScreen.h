...
private:
    ...
    static void _PerformCurrencyExchangeMenueOption(enCurrenciesMainMenueOptions CurrenciesMainMenueOption) {
...
public:
	...
	static void ShowCurrenciesMenue() {
        ...
        _PerformCurrencyExchangeMenueOption((enCurrenciesMainMenueOptions)_ReadCurrenciesMainMenueOptions());   
